...
-- Volcando estructura para tabla tienda.fotoproducts
...
-- Volcando datos para la tabla tienda.fotoproducts: ~8 rows (aproximadamente)
...
-- Volcando estructura para tabla tienda.pedidostemporales
...
-- Volcando datos para la tabla tienda.pedidostemporales: ~6 rows (aproximadamente)
INSERT IGNORE INTO `pedidostemporales` (`id`, `producto_id`, `cantidad`, `nuevoPrecioTotal`, `tokenCliente`, `fecha`) VALUES
	(1, 7, 2, 170000, '3U336aJ0yiBxc3v3bmf3MDuv7nYRUYZa', '2023-08-10 01:25:01'),
	(2, 2, 21, 7140000, '3U336aJ0yiBxc3v3bmf3MDuv7nYRUYZa', '2023-08-10 01:40:39'),
	(3, 8, 1, 340000, '3U336aJ0yiBxc3v3bmf3MDuv7nYRUYZa', '2023-08-10 01:40:54'),
	(4, 3, 1, 70000, '3U336aJ0yiBxc3v3bmf3MDuv7nYRUYZa', '2023-08-10 02:09:34'),
	(5, 2, 13, 4420000, '7W8fKYnAP7DU2cg4kd4ZyA697eHaQrMw', '2023-08-10 02:34:10'),
	(6, 8, 12, 4080000, '7W8fKYnAP7DU2cg4kd4ZyA697eHaQrMw', '2023-08-10 02:36:48'),
	(7, 5, 1, 50000, '7W8fKYnAP7DU2cg4kd4ZyA697eHaQrMw', '2023-08-10 02:50:27');
...
-- Volcando datos para la tabla tienda.products: ~8 rows (aproximadamente)
INSERT IGNORE INTO `products` (`id`, `nameProd`, `precio`, `cantidadDisponible`, `descrip_Prod`, `fechaRegistro`) VALUES
